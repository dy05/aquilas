  ...
  if (file) {
    ...
    <form action="{{ route('materielles.update') }}" method="POST">
        ...
        @method('PUT')
                ...
                <input type="text" hidden name="id" value="{{ $materielle->id }}" class="form-control" placeholder="Entre le id">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{$materielle->dimension }}" name="dimension" class="form-control" >
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <input type="number" value="{{$materielle->quantite }}" name="quantite" class="form-control" >
            </div>
        </div>
            <select name="idCategorie" class="form-select" aria-label="Disabled select example">
                <option selected >{{$materielle->idCategorie }}</option>
                @foreach ($cats as $cat )
